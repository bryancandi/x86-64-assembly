...
;    Copy message to a second buffer and display it, too.
        ...
        lea     RSI, keymsg + lengthof keymsg - 1 ; Points to end of input buffer.
        lea     RDI, dismsg + lengthof dismsg - 1 ; Points to end of display buffer.
        mov     RCX, MAXBUF     ; Size of buffer in bytess.
        std                     ; Set direction flag to decrement pointers.
