...
;    Change case of first 16 letters and echo again.

        movdqu  XMM8, xmmword ptr [keymsg] ; First 16 bytes of message.
        pxor    XMM8, xmmword ptr [cvt] ; "Flip" the case of 16 letters.
        movdqu  xmmword ptr [keymsg], XMM8 ; Overlay with changed case letters.
        txtOut  keymsg, nbrd    ; Write modified text to command box.

;    Convert to lower case and echo again

        por     XMM8, xmmword ptr [cvt] ; "Flip" the case of 8 letters.
        movdqu  xmmword ptr [keymsg], XMM8 ; Overlay with changed case letters.
        txtOut  keymsg, nbrd    ; Write modified text to command box.
...
;cvt     byte    16 DUP (20h)    ; Pattern to convert letter case (hexadecimal).
cvt     byte    16 DUP (00100000b) ; Pattern to convert letter case (set 5th binary bit).
