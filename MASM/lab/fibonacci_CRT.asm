...
; Date  : 2026-04-14
;
; Uses C Runtime (CRT). Entry will be mainCRTStartup.
; Assemble with MASM and link:
; ml64.exe fibonacci_CRT.asm /link /SUBSYSTEM:console msvcrt.lib
;==============================================================
...
exit:
        ; Restore non-volatile registers and stack shadow space
        add     rsp, 40
        pop     r13
        pop     r12

        xor     ecx, ecx
        ret                                 ; Return to caller (mainCRTStartup)
main    ENDP
        END
